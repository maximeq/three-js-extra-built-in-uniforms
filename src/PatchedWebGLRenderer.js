...
const riangleStripDrawMode = THREE.riangleStripDrawMode;
...
const WebGLAnimation = THREE.WebGLAnimation;
const WebGLAttributes = THREE.WebGLAttributes;
const WebGLBackground = THREE.WebGLBackground;
const WebGLBufferRenderer = THREE.WebGLBufferRenderer;
const WebGLCapabilities = THREE.WebGLCapabilities;
const WebGLClipping = THREE.WebGLClipping;
const WebGLExtensions = THREE.WebGLExtensions;
const WebGLGeometries = THREE.WebGLGeometries;
const WebGLIndexedBufferRenderer = THREE.WebGLIndexedBufferRenderer;
const WebGLInfo = THREE.WebGLInfo;
const WebGLMorphtargets = THREE.WebGLMorphtargets;
const WebGLObjects = THREE.WebGLObjects;
const WebGLPrograms = THREE.WebGLPrograms;
const WebGLProperties = THREE.WebGLProperties;
const WebGLRenderLists = THREE.WebGLRenderLists;
const WebGLRenderStates = THREE.WebGLRenderStates;
const WebGLShadowMap = THREE.WebGLShadowMap;
const WebGLState = THREE.WebGLState;
const WebGLTextures = THREE.WebGLTextures;
const WebGLUniforms = THREE.WebGLUniforms;
const WebGLUtils = THREE.WebGLUtils;
const WebVRManager = THREE.WebVRManager;
const WebXRManager = THREE.WebXRManager;
const cloneUniforms = THREE.UniformsUtils.clone;
