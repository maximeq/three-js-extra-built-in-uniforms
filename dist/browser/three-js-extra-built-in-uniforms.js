(function (global, factory) {
	...
	(global.THREEExtraBuiltInUniforms = factory(global.THREE));
}(this, (function (threeFull) { 'use strict';

	threeFull = threeFull && threeFull.hasOwnProperty('default') ? threeFull['default'] : threeFull;

	///////////////////////////////////////////////////////////////////////////////////////////////////
	// This file is generated from package three-full/sources/renderers/WebGLRenderer                //
	// A hook is added on the private RenderObject function to update extra uniforms if the material //
	// needs them.                                                                                   //
	///////////////////////////////////////////////////////////////////////////////////////////////////



	const REVISION = threeFull.REVISION;
	const RGBAFormat = threeFull.RGBAFormat;
	const HalfFloatType = threeFull.HalfFloatType;
	const FloatType = threeFull.FloatType;
	const UnsignedByteType = threeFull.UnsignedByteType;
	const TriangleFanDrawMode = threeFull.TriangleFanDrawMode;
	const riangleStripDrawMode = threeFull.riangleStripDrawMode;
	const TrianglesDrawMode = threeFull.TrianglesDrawMode;
	const LinearToneMapping = threeFull.LinearToneMapping;
	const BackSide = threeFull.BackSide;
	const _Math = threeFull._Math;
	const DataTexture = threeFull.DataTexture;
	const Frustum = threeFull.Frustum;
	const Matrix4 = threeFull.Matrix4;
	const ShaderLib = threeFull.ShaderLib;
	const UniformsLib = threeFull.UniformsLib;
	const Vector3 = threeFull.Vector3;
	const Vector4 = threeFull.Vector4;
	const WebGLAnimation = threeFull.WebGLAnimation;
	const WebGLAttributes = threeFull.WebGLAttributes;
	const WebGLBackground = threeFull.WebGLBackground;
	const WebGLBufferRenderer = threeFull.WebGLBufferRenderer;
	const WebGLCapabilities = threeFull.WebGLCapabilities;
	const WebGLClipping = threeFull.WebGLClipping;
	const WebGLExtensions = threeFull.WebGLExtensions;
	const WebGLGeometries = threeFull.WebGLGeometries;
	const WebGLIndexedBufferRenderer = threeFull.WebGLIndexedBufferRenderer;
	const WebGLInfo = threeFull.WebGLInfo;
	const WebGLMorphtargets = threeFull.WebGLMorphtargets;
	const WebGLObjects = threeFull.WebGLObjects;
	const WebGLPrograms = threeFull.WebGLPrograms;
	const WebGLProperties = threeFull.WebGLProperties;
	const WebGLRenderLists = threeFull.WebGLRenderLists;
	const WebGLRenderStates = threeFull.WebGLRenderStates;
	const WebGLShadowMap = threeFull.WebGLShadowMap;
	const WebGLState = threeFull.WebGLState;
	const WebGLTextures = threeFull.WebGLTextures;
	const WebGLUniforms = threeFull.WebGLUniforms;
	const WebGLUtils = threeFull.WebGLUtils;
	const WebVRManager = threeFull.WebVRManager;
	const WebXRManager = threeFull.WebXRManager;
	const cloneUniforms = threeFull.UniformsUtils.clone;
	...
	var PatchedWebGLRenderer = WebGLRenderer;
