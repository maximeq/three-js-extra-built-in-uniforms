...
I = e.WebGLPrograms,
C = e.WebGLProperties,
B = e.WebGLRenderLists,
F = e.WebGLRenderStates,
W = e.WebGLShadowMap,
P = e.WebGLState,
G = e.WebGLTextures,
D = e.WebGLUniforms,
...
(ve = new U($, ee, te)),
(ae = new P($, ee, ve, te)).scissor(ye.copy(We).multiplyScalar(Be)),
ae.viewport(Te.copy(Fe).multiplyScalar(Be)),
(re = new y($)),
(ie = new C()),
...
(this.vr = Ye);
var He = new W(ge, le, te.maxTextureSize);
function Xe(e) {
...
void 0 !== e && ((Be = e), this.setSize(Ie, Ce, !1));
}),
...
return {width: Ie * Be, height: Ce * Be};
}),
...
Fe.set(e, Ce - t - r, a, r), ae.viewport(Te.copy(Fe).multiplyScalar(Be));
}),
(this.setScissor = function(e, t, a, r) {
We.set(e, Ce - t - r, a, r), ae.scissor(ye.copy(We).multiplyScalar(Be));
}),
(this.setScissorTest = function(e) {
ae.setScissorTest((Pe = e));
}),
...
M = f.z * Ie,
b = f.w * Ce;
ae.viewport(Te.set(v, g, M, b).multiplyScalar(Be));
}
...
Te.copy(Fe).multiplyScalar(Be), ye.copy(We).multiplyScalar(Be), (Ee = Pe);
if (
...
patchedWebGLRenderer: z
};
return (
(e.WebGLRenderer = j.patchedWebGLRenderer), (e.ExtraBuiltInUniforms = j), j
);
});
