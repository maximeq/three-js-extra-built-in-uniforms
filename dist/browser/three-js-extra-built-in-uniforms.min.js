...
(ve = new U($, ee, te)),
(ae = new W($, ee, ve, te)).scissor(ye.copy(Pe).multiplyScalar(Be)),
...
Pe.set(e, Ce - t - r, a, r), ae.scissor(ye.copy(Pe).multiplyScalar(Be));
}),
...
Te.copy(Fe).multiplyScalar(Be), ye.copy(Pe).multiplyScalar(Be), (Ee = We);
if (
...
return (e.WebGLRenderer = z), (e.ExtraBuiltInUniforms = j), j;
});
